...
path = r"C:\Users\jbmor\Desktop\TRA3601_corpus\Troubleshooting_FR\\"
prefix = "NINTENDO_Troubleshooting_"
language = "_FR"
...
for article_url in article_url_list:
    ...
    with open(path + file_name + ".txt", "w", encoding="UTF-8") as output:
            try:
                ...
                paragraphs = soup.find("div", class_="rn_RecordText rn_AnswerText")
